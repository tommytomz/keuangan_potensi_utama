...
HTML;
    ...
    protected function initExport()
    {
        ...
        $this->export = array_replace_recursive(
            [
                ...
                'messages' => [
                    ...
                    'confirmDownload' => Yii::t('kvgrid', 'Tekan OK untuk proses'),
        ...
        $pdfHeader = [
            'L' => [
                //'content' => Yii::t('kvgrid', 'Yii2 Grid Export (PDFoooo)'),
                'content' => '',
                'font-size' => 8,
                'color' => '#333333',
            ],
                ...
                'content' => "<table style='text-align:center; width:100%'>
                    <tr>
                        <td style='width:140px; border:0px;'>
                            <img src='".Url::base(true)."/images/logo_upu100.png' width='80' height='80'>
                        </td>
                        <td style='border:0px;'>
                            <h4 style='margin-bottom:0px; font-weight:bold;'>UNIVERSITAS POTENSI UTAMA</h4>
                            <b style='font-size:14px;'>".$this->headertitle."</b><br>
                            <b style='font-size:14px;'>".$this->subtitle."</b>
                        </td>
                    </tr>
                </table>
                <hr size='1'>",
        ...
        $defaultExportConfig = [
            ...
            self::PDF => [
                ...
                'showFooter' => true,
                'showCaption' => true,
                'filename' => str_replace(" ", "_", $this->headertitle).date('Ymd-His'),
                'alertMsg' => Yii::t('kvgrid', $this->headertitle),
