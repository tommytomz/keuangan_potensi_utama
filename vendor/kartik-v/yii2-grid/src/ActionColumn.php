...
class ActionColumn extends YiiActionColumn
{
    ...
    {
        $isBs4 = $this->grid->isBs4();
        $this->setDefaultButton('view', Yii::t('kvgrid', 'View'), $isBs4 ? 'eye' : 'eye-open btn btn-success btn-xs rounded');
        $this->setDefaultButton('update', Yii::t('kvgrid', 'Update'), $isBs4 ? 'pencil-alt' : 'pencil btn btn-primary btn-xs rounded');
        $this->setDefaultButton('delete', Yii::t('kvgrid', 'Delete'), $isBs4 ? 'trash-alt' : 'trash btn btn-danger btn-xs rounded');
    }
