...
<div class="transaksi-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable',
            'headertitle' => 'LAPORAN BUKU BESAR',
            'subtitle' => $subtitle,
            'id'=>'crud-datatable',
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Daftar Buku Besar',
                //'before'=>$before,
...
$js = "
    ...
    $('#caridata').click(function() {
            //alert('tes');
            $.pjax.reload({'push':true, 'replace':true, 'scrollTo':false, container: '#crud-datatable-pjax', url:'".Yii::$app->request->baseUrl."/index.php?r=bukubesar&Transaksi[tanggal_dari]='+$( 'input#tanggal_dari' ).val()+'&Transaksi[tanggal_sampai]='+$( 'input#tanggal_sampai' ).val(), timeout: 1000});
        });
