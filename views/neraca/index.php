...
<?php
    $js = "
        jQuery('#caridata').click(function() {
            //alert('tes');
            $.pjax.reload({'push':true, 'replace':true, 'scrollTo':false, container: '#crud-datatable-pjax', url:'".Yii::$app->request->baseUrl."/index.php?r=neraca&Transaksi[tanggal_dari]='+$( 'input#tanggal_dari' ).val()+'&Transaksi[tanggal_sampai]='+$( 'input#tanggal_sampai' ).val(), timeout: 1000});
        });
