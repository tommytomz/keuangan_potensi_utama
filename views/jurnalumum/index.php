...
<div class="transaksi-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'headertitle' => 'LAPORAN JURNAL UMUM',
            'subtitle' => $subtitle,
            'id'=>'crud-datatable',
            'id'=>'crud-datatable',
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Daftar Jurnal Umum',
                //'before'=>$before,
...
$js = "
    ...
    $('#caridata').click(function() {
        $.pjax.reload({'push':true, 'replace':false, container: '#crud-datatable-pjax', url:'".Yii::$app->request->baseUrl."/index.php?r=jurnalumum&Transaksi[tanggal_dari]='+$( 'input#tanggal_dari' ).val()+'&Transaksi[tanggal_sampai]='+$( 'input#tanggal_sampai' ).val(), timeout: 1000});
