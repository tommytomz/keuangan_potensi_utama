...
class ExportController extends Controller
{
    ...
    public function actionDownload()
    {
        ...
        <table border=0 width="100%">
            <tr>
                <td><img src="'.Yii::$app->request->baseUrl.'/images/logo_upu.jpg" width="100" height="100"></td>
                <td align="center" width=""><h2>UNIVERSITAS POTENSI UTAMA</h2></td>
            </tr>
        </table>
        <br><br>
        ';
        ...
        $content = $content.$request->post('export_content', Yii::t('kvgrid', 'No data found'));
